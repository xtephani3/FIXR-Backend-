...
Analyze the user's problem. Pick the Top 3 best matching artisans from the list based strictly on the relevance of their "service" and "bio" to the user's problem, their "city" matching the user's location, and high "avgRating". 

Respond STRICTLY with a valid JSON array of objects (and nothing else, no markdown fences). 
Format exactly like this:
[
  { "artisanId": "id_here", "reason": "Short 1-sentence explanation of why they are a good fit." }
]`;
